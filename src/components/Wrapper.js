      ...
      <View style={styles.topRow}>
        ...
        <View style={styles.iconContainer}>
          ...
          >
            ...
            {isMuted && (
              <Image source={require(`../assets/mute.png`)} style={styles.icon} />
            )}
          </Pressable>
          <Pressable
            onPress={() => {
          ...
          >
            ...
            {isDarkMode && (
              <Image source={require("../assets/bulb.png")} style={styles.icon} />
            )}
          </Pressable>
        </View>
        ...
        {timer && (
          <View style={styles.topTimerContainer}>
            <Text style={styles.topTimerText}>{countdown} s</Text>
          </View>
        )}
      ...
      <View style={styles.bottomRow}>
        {timer && (
          <View style={styles.bottomTimerContainer}>
            ...
            />
            <Text style={styles.bottomTimerText}>{countdown} s</Text>
          </View>
        )}
